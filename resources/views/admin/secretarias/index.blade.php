...
<div class="panel" id="app">
    ...
    <div class="panel-heading">
        <h4 class="panel-title">Listado de Secretarias</h4>
    </div>

    <a href="{{ url('secretarias/create') }}" class="btn btn-default btn-add"><i style="margin-right: 5px" class="fa fa-plus"></i>Agregar Secretaria</a>
...
<script>
  	...
  	let App = Vue.createApp({
    	...
    	methods: {
            ...
            filterAcronimo: function(element){
	    		this.page 			= 1;
            ...
            update_filters: function(){
				...
				if(this.acronimo  	!= '') this.filters.push({ key: 'acronimo', 	value: this.acronimo_text, 		name: 'acronimo'    });
