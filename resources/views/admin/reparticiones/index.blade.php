    ...
    <div class="panel-body">
        ...
        <div class="table-responsive">
            <table class="table nomargin">
                ...
                <tbody>
                    <tr v-for="item in data.data" @click="$root.show(item.reparticion_id)">
...
<script type="text/x-template" id="button-create-template">
    <a href="{{ url('reparticiones/create') }}" class="btn btn-default btn-add"><i style="margin-right: 5px" class="fa fa-plus"></i>Agregar @{{ $root.title }}</a>
</script>
  	...
  	let App = Vue.createApp({
    	...
    	methods: {
            ...
            show: function(id, event){
                window.location = "{{ url('reparticiones') }}"+'/'+id+'/edit';
            },
