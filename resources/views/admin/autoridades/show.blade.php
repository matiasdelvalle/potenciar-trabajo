...
<div class="grid-programa" id="app">
    ...
    <div style="display: block" class="detalle-tabla" v-if="autoridades.length > 0 || tecnicos.length > 0">
        <div>
            <button @click="$root.show('autoridades')" id="autoridades"    class="btn-autoridad btn-autoridad--active"> Autoridades </button>
            <button @click="$root.show('tecnicos')"    id="tecnicos"       class="btn-autoridad"> Técnicos </button>
            <div class="float-right">
                <button class="btn-autoridad--active" id="add-autoridad" @click="createAutoridad"> <i class="fa fa-user-plus"></i> <span class="text-min">Agregar autoridad</span> </button>
                <button class="btn-autoridad--active" id="add-tecnico"  @click="createTecnico" style="display:none"> <i class="fa fa-user-plus"></i> <span class="text-min">Agregar tecnicos</span> </button>
            </div>
        </div>
        <div id="show-autoridades">
            <div class="d-grid">
        ...
        <div style="display: none" id="show-tecnicos">
            <div class="d-grid">
    ...
    <div class="box-programa-vacio" style="display:block" v-if="autoridades.length == 0 && tecnicos.length == 0">
        <h2>No hay autoridades ni técnicos para este programa</h2>
        <img class="img-responsive icono-no-autoridad" src="{{ asset('/images/no-autoridad.svg') }}" alt="No hay autoridades">
        <div class="bottom-box-vacio">
            <button class="btn-autoridad"           id="add-autoridad"  @click="createAutoridad"><i class="fa fa-user-plus"></i> <span>Agregar autoridad</span> </button>
            <button class="btn-autoridad--active"   id="add-tecnico"    @click="createTecnico"><i class="fa fa-user-plus"></i> <span>Agregar tecnicos</span> </button>
        </div>
    </div>
...
<a href="{{ url('programas') }}/{{ $d->programa_id }}/edit" data-toggle="tooltip" title="Editar Programa    " data-placement="left" style="width:50px;height:50px;background-color:#37BBED;border-radius:25px;position:fixed;bottom:20px;right:20px;text-align:center;font-size:24px;color:#fff;padding-top:11px;;z-index: 9999"><i class="icon-File-Edit"></i></a>
@endsection
    ...
    let App = Vue.createApp({
    	...
    	methods: {
            ...
            deleteTecnico: function(id){
                ...
                swal({
                    title: "{{ env('APP_NAME') }}",
                    text: '¿Está seguro de eliminar este Tecncio?',
                    showCloseButton: true,
                    showCancelButton: true,
                    confirmButtonText: 'Eliminar',
                    cancelButtonText:  'Cancelar',
